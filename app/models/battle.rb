...
class BattleValidator < ActiveModel::Validator
  def validate(record)
    unless record.lists.count < 3
      record.errors.add :base, 'Maximum 2 lists'
    end
  end
end
...
class Battle < ApplicationRecord
  ...
  # validate :max_two_lists
  #
  # def max_two_lists
  #   if self.lists.count > 3
  #     errors.add(self.lists, "can't have more than 2 lists")
  #   end
  # end
  ...
  validates_with BattleValidator


end
  # has_many :units, through: :detachments
  # has_many :datasheets, through: :detachments
